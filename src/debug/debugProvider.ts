...
export interface IDebugProvider {
     ...
     */
    startDebugging(workspaceFolder: string, sessionName: string, port: number | undefined, pod: string, container: string | undefined, pidToDebug: number | undefined): Promise<boolean>;
